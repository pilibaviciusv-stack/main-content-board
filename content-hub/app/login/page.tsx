...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        width: 380, background: '#0a0c11',
        border: '1px solid #1e2130', borderRadius: 16,
        padding: '40px 36px',
      }}>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div>
            ...
            <input
              ...
              style={{
                width: '100%', padding: '10px 14px', background: '#0d0f14',
                border: '1px solid #1e2130', borderRadius: 8, color: '#e2e8f0',
          ...
          {error && (
            <div style={{ fontSize: 13, color: '#ef4444', background: '#1a0f0f', border: '1px solid #3b1515', borderRadius: 8, padding: '10px 14px' }}>
              {error}
            </div>
          )}
