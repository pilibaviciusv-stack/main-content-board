...
import { LayoutGrid, Music, Film, Settings, Plus, Layers, PlaySquare, Video, BarChart2, Map, Users, Grid3x3, TrendingUp, Target } from 'lucide-react';
...
export default function JorisHub() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#0d0f14', flexDirection: 'column', gap: 16 }}>
      <div style={{ width: 40, height: 40, background: 'linear-gradient(135deg, #ef4444, #f97316)', borderRadius: 10 }} />
    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#0d0f14' }}>
      ...
      <div style={{ width: 220, background: '#0a0c11', borderRight: '1px solid #1e2130', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
        <div style={{ padding: '20px 16px 16px', borderBottom: '1px solid #1e2130' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: '#475569' }}>Joris · Vabanque</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '12px 16px', borderTop: '1px solid #1e2130' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, color: '#ef4444' }}>{thisWeek}</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          {view.type === 'pipeline' && activePipeline && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <button onClick={addNewCard}
                style={{ display: 'flex', alignItems: 'center', gap: 6, background: '#ef4444', color: '#fff', border: 'none', borderRadius: 8, padding: '8px 16px', cursor: 'pointer', fontSize: 13, fontWeight: 600 }}>
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: 24 }}>
          ...
          {view.type === 'analytics' && <Analytics cards={state.cards} hubSlug="joris" />}
