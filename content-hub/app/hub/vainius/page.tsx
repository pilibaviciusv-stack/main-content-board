...
const CURRENT_USER = { email: 'vainius@pluginfo.com', isOwner: true };
    ...
    <div className="hub-layout" style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#0d0f14' }}>
      ...
      <div className="hub-main" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div className="hub-content" style={{ flex: 1, overflow: view.type === 'table' ? 'hidden' : 'auto', padding: view.type === 'table' ? 0 : 24, display: 'flex', flexDirection: 'column' }}>
          ...
          {view.type === 'analytics' && <Analytics cards={state.cards} channelHandle="VainiusPilibaviciusv" hubSlug="vainius" />}
          {view.type === 'pipeline' && activePipeline && (
